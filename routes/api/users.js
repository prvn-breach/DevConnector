...
const gravatar = require('gravatar'); // Gravatar for email
const jwt = require('jsonwebtoken'); // Create token
const keys = require('../../config/keys'); // Keys Config
const passport = require('passport'); // Authenticate using passport
